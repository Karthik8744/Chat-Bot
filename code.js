...
async function identify_user(agent)
{
  ...
  console.log(snap);
  if(snap==null){
	  await agent.add("Please enter valid mobile number");
...
function report_issue(agent)
{
  ...
  var issue_vals={1:"Internet is Down",2:"Slow Internet",3:"Buffering problem",4:"No connectivity"};
 ...
 agent.add("The issue reported is: "+ val +"\nThe ticket generated is: "+trouble_ticket);
}
